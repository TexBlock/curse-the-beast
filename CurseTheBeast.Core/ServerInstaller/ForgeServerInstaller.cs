using CurseTheBeast.Core.Api.Forge;
...
public class ForgeServerInstaller : AbstractModServerInstaller
{
    ...
    private async Task<string?> generateModifiedInstaller(CancellationToken ct)
    {
        ...
        // 打开原安装包
        using var srcZip = new ZipArchive(File.OpenRead(_installer.LocalPath), ZipArchiveMode.Read, false, MyEncoding.UTF8);
        ...
        using var dstZip = new ZipArchive(dstFs, ZipArchiveMode.Create, true, MyEncoding.UTF8);
